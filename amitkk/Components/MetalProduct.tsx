...
//             />
//             <p className="uppercase text-xs tracking-wider text-gray-500 mt-2 sm:mt-4">Anmol Craft and Creation</p>
//             <h3 className="text-sm sm:text-lg font-medium text-gray-900">Anmol Craft and Creation - THE HORSE</h3>
...
//             />
//             <p className="uppercase text-xs tracking-wider text-gray-500 mt-2 sm:mt-4">Anmol Craft and Creation</p>
//             <h3 className="text-sm sm:text-lg font-medium text-gray-900">Anmol Craft and Creation Wall Hanger - Fish</h3>
